  ...
  return (
    <>
      <style>{`
        ...
        .wc-image-bg { position: absolute; inset: 0; background: radial-gradient(ellipse at 50% 30%, rgba(139,26,46,0.2), transparent 70%); }
        .wc-bottle-icon { font-size: 3.5rem; position: relative; z-index: 1; filter: drop-shadow(0 4px 12px rgba(196,69,105,0.3)); }
        ...
        .wc-type-badge {
          ...
          color: rgba(245,230,232,0.9); z-index: 2;
        }
        ...
        .wc-qty {
          ...
          font-size: 0.65rem; color: rgba(245,230,232,0.35);
          background: rgba(0,0,0,0.4); padding: 0.15rem 0.4rem;
